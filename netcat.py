...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
            description="netcat clone",
            formatter_class=argparse.RawDescriptionHelpFormatter,
            epilog=textwrap.dedent('''Usage:
                netcat.py -t <IP> -p <PORT> -l -c # interactive shell
                netcat.py -t <IP> -p <PORT> -l -u=<FILE> # upload a file
                netcat.py -t <IP> -p <PORT> -l -e=\"cat /etc/passwd\" # execute command
                echo "XYZ" | ./netcat.py -t <IP> -p <PORT> # pipe to netcat.py
